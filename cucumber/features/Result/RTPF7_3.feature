Feature:
	...
	Results Page Functionality 7 with search for Pizza and addition of Anko to Do Not Show and Super Lemon  Cream to Favorites
...
Background:
	...
	And I clicked the link for "Super Lemon  Cream"
...
Scenario: Add items to lists and have results change appropriately (RTPF7b, RTPF7c, RTPF7a)
	...
	Then I should see "Super Lemon  Cream" as the first result for "Recipes"
